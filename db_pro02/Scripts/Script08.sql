...
-- A
CREATE USER dev01 IDENTIFIED BY dev01;		-- 계정 생성

GRANT CONNECT, RESOURCE, CREATE SESSION TO dev01;	-- 권한부여

COMMIT;

-- B
CREATE USER dev02 IDENTIFIED BY dev02;		-- 계정 생성

GRANT CONNECT, CREATE SESSION, INSERT ANY TABLE, UPDATE ANY TABLE, DELETE ANY TABLE TO dev02;		-- 권한부여

COMMIT;

-- C
CREATE USER devAdmin IDENTIFIED BY devAdmin;		-- 계정 생성

GRANT CONNECT, RESOURCE, CREATE SESSION, INSERT ANY TABLE, UPDATE ANY TABLE, DELETE ANY TABLE, CREATE VIEW TO devAdmin;		-- 권한부여
...
-- INSERT INTO USER_ACCOUNT VALUES(ID, USERNAME, PASSWORD, NAME, AGE, GENDER);
INSERT INTO USER_ACCOUNT VALUES(USER_ACCOUNT_SEQ.NEXTVAL, 'user1', 'user1', '사용자1', 23, 'F');
-- INSERT INTO INFO_ACCOUNT VALUES(ID, ADDRESS, EMAIL, PHONE);
