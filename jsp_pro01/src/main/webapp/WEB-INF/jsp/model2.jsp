...
<body>
	...
	<p>
		...
		코드를 작성하였는지 관리가 잘 안된다.<br>
		하나의 페이지에 HTML, CSS, JS, JSP, Java, SQL 구문들이 섞여 있기 때문에 코드의 스파게티화가 발생하게 된다.
	</p>
	<hr>
	...
	<ol>
		...
		<li>처리 결과를 받은 DeptController 는 결과에 적합한 View 를 선정하여 화면 구성을 할 수 있게 데이터를 View 에 전달한다.</li>
