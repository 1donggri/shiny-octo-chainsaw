...
public class Sample01 {
	...
	public static void main(String[] args) {
		 ...
		 * 		- 조건문의 종류는 if, if ... else, if ... else if, switch가 있다.
		 */
		...
		if(num > 10) {
			System.out.println("num 변수에 저장된 값은 10보다 큽니다.");
		}
		 ...
		 * 		} ... {
		 * 			조건식3의 결과가 거짓이고 대신 생략된 문장 안의 조건식의 결과가 참일 때 실행할 코드를 여기에 작성한다.
		 * 		} else {
		...
		if(num <= 19) {
			if(num >= 13 && num <= 15) {
				System.out.print("미성년자 입니다. (중학생 입니다.)");
