...
-- LOCATIONS 테이블에서 COUNTRY_ID 가 US 인 데이터를 조회 할 때
...
-- EMPLOYEE 테이블에서 COMMISSION_PCT 가 NULL 이 아니면서 SALARY 가 10000 이상인
...
-- EMPLOYEES 테이블에서 EMAIL 컬럼을 조회 할 때 EMAIL@JOB_ID.employee.com 형식으로 조회
-- 되도록 한다.
...
SELECT EMPLOYEE_ID
	,  FIRST_NAME
	,  LAST_NAME
	,  EMAIL || '@' || JOB_ID || '.employee.com' "EMAIL"
	,  PHONE_NUMBER
	,  HIRE_DATE
	,  JOB_ID
	,  SALARY
